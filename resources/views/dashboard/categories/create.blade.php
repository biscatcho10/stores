...
@section('title', __("admin\categories.add main categories") )
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">  {{__("admin\categories.add main categories")}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{__("admin\categories.add main categories")}} </h4>
                                    ...
                                    <form class="form" action="{{route('admin.maincategories.store')}}" method="POST"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row hidden" id="cats_list" >
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="my-3"> {{__('admin/categories.choose the category')}}</label>
