...
@section('title', __("admin\brands.edit brand") )
            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__("admin\brands.home")}} </a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('admin.brands')}}"> {{__("admin\brands.brands")}} </a>
                            </li>
                            <li class="breadcrumb-item active"> {{ __("admin\brands.edit brand")}} - {{$brand -> name}}
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <form class="form" action="{{route('admin.brands.update',$brand-> id)}}"  method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img src=" {{ $brand->photo }} " class="rounded-circle  height-150" alt='{{ __("admin\brands.image")}}'>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="name"> {{ __("admin\brands.name")}}
                                                        </label>
                                                        <input type="text" id="name" class="form-control"
                                                            placeholder="  " value="{{$brand -> name}}" name="name">
                                                        @error("name")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        ...
                                                        <label for="status" class="card-title ml-1">{{ __("admin\brands.status")}}
                                                        </label>
