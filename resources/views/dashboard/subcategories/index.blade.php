...
@section('title', __("admin\categories.Sub categories") )
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> {{__("admin\categories.Sub categories")}} </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{__("admin\categories.home")}}}"></a>{{__("admin\categories.home")}}
                            </li>
                            <li class="breadcrumb-item active"> {{__("admin\categories.Sub categories")}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__("admin\categories.Sub categories")}} </h4>
                                    ...
                                    <table class="table display nowrap table-striped table-bordered scroll-horizontal">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th>{{__("admin\categories.main category name")}}</th>
