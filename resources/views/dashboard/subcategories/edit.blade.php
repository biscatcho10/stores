...
@section('title', __("admin\categories.edit Sub categories") )
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.subcategories')}}"> {{__("admin\categories.Sub categories")}} </a>
                            </li>
                            <li class="breadcrumb-item active">{{ __("admin\categories.edit Sub categories")}} - {{$category -> name}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{ __("admin\categories.edit Sub categories")}} </h4>
                                    ...
                                    <form class="form" action="{{route('admin.subcategories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="projectinput2"> {{ __("admin\categories.choose the category")}} </label>
                                                        <select name="parent_id" class="select2 form-control">
                                                            <optgroup label='{{__("admin\categories.please choose the category")}}'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> {{ __("admin\categories.slug")}}
                                                        </label>
                                                        <input type="text" id="name" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1">
                                                        ...
                                                        <label for="switcheryColor4" class="card-title ml-1">{{ __("admin\categories.status")}}
                                                        </label>
