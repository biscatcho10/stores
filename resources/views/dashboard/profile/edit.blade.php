                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> تعديل بيانا الملف الشخصي </h4>
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('update.profile')}}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="password1"> كلمة المرورالجديدة </label>
                            ...
                            {{-- <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{route('update.profile.password')}}" method="post"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
