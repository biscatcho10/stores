...
@section('title', __('admin\languages.edit language') )
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{__('admin/languages.edit language')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{__('admin/languages.edit language')}} </h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action=" {{ route('admin.languages.update', $lang->id) }} " method="POST" ctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="direction" class="select2 form-control">
                                                            <optgroup label="{{__('admin/languages.please choose the dir')}}  ">
                                                                <option value="rtl" @if ($lang->direction == 'rtl')
                                                                    selected
                                                                @endif>{{__('admin/languages.right to left')}}</option>
                                                                <option value="ltr"  @if ($lang->direction == 'ltr')
                                                                    selected
                                                                @endif>{{__('admin/languages.left to right')}}</option>
                                                            </optgroup>
                                                        </select>
                                                        @error('direction')
                                                            <span class="text-danger">{{ $message}}</span>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="la la-check-square-o"></i> {{__('admin/languages.update')}}
                                            </button>
                                        </div>
                                    </form>
                                </div>
