...
@section('title', __("admin/tags.add tag"))
            ...
            <div class="content-header-left col-md-6 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href=" {{route('admin.dashboard')}} ">{{__("admin/tags.home")}} </a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('admin.tags')}}"> {{__("admin/tags.tags")}} </a>
                            </li>
                            <li class="breadcrumb-item active">{{__("admin/tags.add tag")}}
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <form class="form" action="{{route('admin.tags.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="la la-check-square-o"></i> {{__("admin/tags.save")}}
                                            </button>
                                        </div>
                                    </form>
